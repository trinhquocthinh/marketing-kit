...
import { LabelEnum, TabEnum } from '@/types/enums';
    ...
    <div>
      <div className="flex items-center gap-2 mb-4">
        {icon === 'heart' ? (
          ...
          <svg className="w-5 h-5 text-[#FA875B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center border-t border-gray-100 divide-x divide-gray-100">
        <button
          onClick={onFavorite}
          className="flex-1 flex items-center justify-center py-2 hover:bg-gray-50 transition-colors"
          title={I18n.marketingDashboard.favorite}
        >
          <svg
            className={`w-4 h-4 ${isFav ? 'text-red-500 fill-current' : 'text-gray-400'}`}
