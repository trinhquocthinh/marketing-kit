...
const PosterCanvas = forwardRef<HTMLDivElement, PosterCanvasProps>(function PosterCanvas(
  { imageUrl, avatarUrl, qrData, name, phone, imageMeta, showQrPlaceholder = false, zoom = 1 },
  ref,
) {
  ...
  return (
    <div
      ref={ref}
      className="relative inline-block origin-top-left bg-white transition-transform duration-200"
      style={{ transform: `scale(${zoom})` }}
    >
      {/* Template background image */}
      <div className="relative">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={imageUrl} alt="Poster template" className="block h-auto w-full" />
      </div>
      ...
      >
        ...
        <div className="flex items-center gap-[2%]">
          <span
            className="hidden font-[Montserrat,sans-serif] sm:block"
            style={{
              color: textColor,
          ...
          {qrDataUrl && (
            <div
              className="flex shrink-0 items-center justify-center rounded-md bg-white shadow-md"
              style={{
